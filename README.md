...
## 🏗️ What's New in v2.0.1

### Auto-Updater & Quality of Life
- **Auto-Updater System** - Check for and install new URW versions directly from the dashboard!
- **Dynamic Text Resizing** - Auto-adapting choice buttons and text size scaling.
- **Custom Choice Menu** - Toggle between game-default or URW-stylized animated menus.
- **Enhanced Stability** - Fixed persistence issues and improved AST parser reliability.
